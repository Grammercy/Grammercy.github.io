...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(e,t,n){let r=new Float32Array(No),i=new U(0,1,0);return new va({name:`SphericalGaussianBlur`,defines:{n:No,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new va({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Xo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Yo(){return new va({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Xo(),fragmentShader:`
	...
	`}var Zo=class extends an{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ra([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        gl_Position = projectionMatrix * mvPosition;
        float perspectiveScale = 210.0 / max(18.0, -mvPosition.z);
        gl_PointSize = size * uPixelRatio * perspectiveScale;
      }
    `,fragmentShader:`
      varying float vAlpha;
      varying vec3 vColor;
      ...
      void main() {
        ...
        float halo = smoothstep(0.54, 0.08, distanceToCenter);
        float core = smoothstep(0.24, 0.0, distanceToCenter);
        float sparkle = smoothstep(0.08, 0.0, distanceToCenter);
        float twinkleStrength = (1.0 - vAlpha) * 0.18 + 0.05;
        float twinkle =
          1.0 +
          sin(uTime * (0.7 + vSeed * 1.1) + vSeed * 21.0) * twinkleStrength +
          sin(uTime * (1.6 + vSeed * 1.8) + vSeed * 47.0) * twinkleStrength * 0.45;
        float intensity = halo * 0.68 + core * 1.18 + sparkle * 0.55;

        gl_FragColor = vec4(vColor, intensity * vAlpha * twinkle);
      }
    `,uniforms:{uPixelRatio:{value:Math.min(window.devicePixelRatio||1,2)},uTime:{value:0}}}))}function Xl(e){let t=new Map;for(let n of e){if(!n.constellation)continue;let e=t.get(n.constellation)??[];e.push(n),t.set(n.constellation,e)}let n=[],r=[],i=new G(`#8ed8ff`);for(let e of t.values()){let t=[...e].sort((e,t)=>e.magnitude-t.magnitude).slice(0,7);if(t.length<2)continue;let a=t.slice(1),o=[t[0]],s=t[0];for(;a.length>0;){let e=0,t=1/0,n=ql(s.altitude,s.azimuth);a.forEach((r,i)=>{let a=ql(r.altitude,r.azimuth),o=n.distanceTo(a);o<t&&(t=o,e=i)});let[r]=a.splice(e,1);o.push(r),s=r}for(let e=1;e<o.length;e+=1){let t=ql(o[e-1].altitude,o[e-1].azimuth),a=ql(o[e].altitude,o[e].azimuth);if(t.distanceTo(a)>26)continue;n.push(t.x,t.y,t.z,a.x,a.y,a.z);let s=.18+(o[e-1].screenBrightness+o[e].screenBrightness)*.5*.16;for(let e=0;e<2;e+=1)r.push(i.r*s,i.g*s,i.b*s)}}let a=new Rr;return a.setAttribute(`position`,new Er(n,3)),a.setAttribute(`color`,new Er(r,3)),new Yi(a,new Li({transparent:!0,opacity:.9,vertexColors:!0,blending:2,depthWrite:!1}))}function Zl(e,t){let n=document.createElement(`canvas`),r=n.getContext(`2d`);if(!r)return null;let i=t===`constellation`?4:2,a=t===`constellation`?72:28,o=t===`constellation`?38:16,s=t===`constellation`?24:10,c=`system-ui, sans-serif`;r.font=`${t===`constellation`?700:600} ${a}px ${c}`;let l=r.measureText(e),u=Math.ceil(l.width+o*2),d=Math.ceil(a+s*2);n.width=u*i,n.height=d*i,r.scale(i,i),r.font=`${t===`constellation`?700:600} ${a}px ${c}`,r.textAlign=`center`,r.textBaseline=`middle`,t===`constellation`&&(r.fillStyle=`rgba(7, 16, 30, 0.76)`,r.beginPath(),r.roundRect(0,0,u,d,999),r.fill(),r.strokeStyle=`rgba(180, 228, 248, 0.45)`,r.lineWidth=2.5,r.stroke()),r.shadowColor=t===`constellation`?`rgba(122, 193, 233, 0.55)`:`rgba(255, 255, 255, 0.45)`,r.shadowBlur=10,r.fillStyle=t===`constellation`?`#d4f1ff`:`#f6fbff`,r.fillText(e,u/2,d/2);let f=new ia(n);return f.colorSpace=qe,f.generateMipmaps=!1,f.minFilter=g,f.magFilter=g,{texture:f,width:u,height:d}}function Ql(e){let t=new In;for(let n of e){let e=Zl(n.text,n.kind);if(!e)continue;let{texture:r,width:i,height:a}=e,o=new ii(new Wr({map:r,transparent:!0,depthWrite:!1,depthTest:!1})),s=Z*(n.kind===`constellation`?1.045:1.005),c=ql(n.altitude,n.azimuth).normalize().multiplyScalar(s);o.position.copy(c);let l=n.kind===`constellation`?.5:.12;o.scale.set(i/28*l,a/28*l,1),o.renderOrder=n.kind===`constellation`?14:10,t.add(o)}return t}function $l(){return new Ei(new ua(120,48,48),new va({side:1,depthWrite:!1,uniforms:{zenithColor:{value:new G(`#06111d`)},horizonColor:{value:new G(`#163550`)},nadirColor:{value:new G(`#010207`)}},vertexShader:`
        varying vec3 vWorldPosition;
      ...
      `,fragmentShader:`
        ...
        void main() {
          ...
          vec3 color = mix(nadirColor, horizonColor, smoothstep(0.0, 0.48, heightMix));
          color = mix(color, zenithColor, smoothstep(0.48, 1.0, heightMix));
          gl_FragColor = vec4(color, 1.0);
        }
      `}))}function eu(){let e=[];for(let t=0;t<=360;t+=2){let n=Lt.degToRad(t);e.push(Math.sin(n)*Z,0,-Math.cos(n)*Z)}let t=new Rr;return t.setAttribute(`position`,new Er(e,3)),new Gi(t,new Li({color:`#5da9d6`,transparent:!0,opacity:.4}))}function tu(){let e=new Ei(new ua(Q,64,64),new ba({color:`#11263c`,roughness:.98,metalness:0,flatShading:!1}));return e.receiveShadow=!1,e}function nu(e){if(`geometry`in e){let t=e.geometry;t instanceof Rr&&t.dispose()}if(`material`in e){let t=e.material;Array.isArray(t)?t.forEach(e=>{e.map?.dispose(),e.dispose()}):t instanceof Ur&&(t.map?.dispose(),t.dispose())}}function ru({stars:e,labels:t}){let n=(0,l.useRef)(null),r=(0,l.useRef)(null),i=(0,l.useRef)(null),a=(0,l.useRef)(null),o=(0,l.useRef)(null),s=(0,l.useRef)(null),c=(0,l.useRef)(null),u=(0,l.useRef)(null),[d,f]=(0,l.useState)(1),p=d>Wl;return(0,l.useEffect)(()=>{let e=n.current;if(!e)return;let t=new Pl({antialias:!0,alpha:!0});t.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),t.setSize(e.clientWidth,e.clientHeight,!1),t.outputColorSpace=qe,t.domElement.className=`sky-canvas`,e.appendChild(t.domElement);let l=new Wn;l.add(new Ba(`#6184a2`,`#07111b`,.52));let d=new to(`#dbe8f7`,1.55);d.position.set(-28,18,30),l.add(d);let p=new to(`#5f89b1`,.45);p.position.set(18,-10,-26),l.add(p);let m=tu();l.add(m);let h=new In;h.position.set(0,Q+Il,0),l.add(h);let g=new In;g.add($l()),g.add(eu()),h.add(g);let _=new Qa(64,1,.1,300);h.add(_),r.current=t,i.current=l,a.current=_,o.current=g;let v=.35,y=.2,b=v,x=y,S=0,C=null,w=0,T=0,E=new Set,D=new Set,O=0,ee=()=>{let n=e.clientWidth||1,r=e.clientHeight||1;t.setSize(n,r,!1),_.aspect=n/r,_.updateProjectionMatrix();let i=s.current?.material;i instanceof va&&(i.uniforms.uPixelRatio.value=Math.min(window.devicePixelRatio||1,2))},k=new ResizeObserver(ee);k.observe(e);let te=t=>{C=t.pointerId,w=t.clientX,T=t.clientY,e.classList.add(`is-dragging`),e.setPointerCapture(t.pointerId)},A=t=>{if(C!==t.pointerId)return;let n=t.clientX-w,r=t.clientY-T;w=t.clientX,T=t.clientY;let i=Math.max(1,e.clientWidth),a=Math.max(1,e.clientHeight);b+=Rl/i*n,x=Kl(x-zl/a*r,-Ll,Ll)},j=t=>{t!==void 0&&C!==t||(C!==null&&e.hasPointerCapture(C)&&e.releasePointerCapture(C),C=null,e.classList.remove(`is-dragging`))},ne=e=>{if(!(e.target instanceof HTMLElement&&e.target.closest(`input, textarea, select, button`))&&!(e.ctrlKey||e.metaKey||e.altKey)){if(e.key===`ArrowLeft`||e.key===`ArrowRight`||e.key===`ArrowUp`||e.key===`ArrowDown`){e.preventDefault(),E.add(e.key);return}if(e.key===`+`||e.key===`=`||e.code===`NumpadAdd`){e.preventDefault(),D.add(`in`);return}(e.key===`-`||e.key===`_`||e.code===`NumpadSubtract`)&&(e.preventDefault(),D.add(`out`))}},re=e=>{(e.key===`+`||e.key===`=`||e.code===`NumpadAdd`)&&D.delete(`in`),(e.key===`-`||e.key===`_`||e.code===`NumpadSubtract`)&&D.delete(`out`),E.delete(e.key)},M=()=>{E.clear(),D.clear(),j()},N=e=>{j(e.pointerId)};e.addEventListener(`pointerdown`,te),e.addEventListener(`pointermove`,A),e.addEventListener(`pointerup`,N),e.addEventListener(`pointercancel`,N),window.addEventListener(`keydown`,ne),window.addEventListener(`keyup`,re),window.addEventListener(`blur`,M),ee();let ie=e=>{let n=O===0?0:(e-O)/1e3;O=e;let r=Bl/Math.max(1,_.zoom);E.has(`ArrowLeft`)&&(b-=r),E.has(`ArrowRight`)&&(b+=r),E.has(`ArrowUp`)&&(x=Kl(x+r*.9,-Ll,Ll)),E.has(`ArrowDown`)&&(x=Kl(x-r*.9,-Ll,Ll));let i=(D.has(`in`)?1:0)-(D.has(`out`)?1:0);i!==0&&n>0&&f(e=>Kl(e+i*n*Ul,Vl,Hl)),v+=(b-v)*.12,y+=(x-y)*.12;let a=new U(Math.sin(v)*Math.cos(y),Math.sin(y),-Math.cos(v)*Math.cos(y)),o=h.localToWorld(a.clone());_.lookAt(o);let c=s.current?.material;c instanceof va&&(c.uniforms.uTime.value=e*.001),t.render(l,_),S=window.requestAnimationFrame(ie)};return S=window.requestAnimationFrame(ie),()=>{window.cancelAnimationFrame(S),k.disconnect(),E.clear(),D.clear(),j(),window.removeEventListener(`keydown`,ne),window.removeEventListener(`keyup`,re),window.removeEventListener(`blur`,M),e.removeEventListener(`pointerdown`,te),e.removeEventListener(`pointermove`,A),e.removeEventListener(`pointerup`,N),e.removeEventListener(`pointercancel`,N),s.current&&o.current&&(o.current.remove(s.current),nu(s.current),s.current=null),c.current&&o.current&&(o.current.remove(c.current),nu(c.current),c.current=null),u.current&&o.current&&(o.current.remove(u.current),u.current.traverse(nu),u.current=null),l.traverse(nu),t.dispose(),r.current=null,i.current=null,a.current=null,o.current=null,e.contains(t.domElement)&&e.removeChild(t.domElement)}},[]),(0,l.useEffect)(()=>{let e=a.current;e&&(e.zoom=d,e.updateProjectionMatrix())},[d]),(0,l.useEffect)(()=>{let t=o.current;if(!t)return;s.current&&=(t.remove(s.current),nu(s.current),null),c.current&&=(t.remove(c.current),nu(c.current),null),u.current&&=(t.remove(u.current),u.current.traverse(nu),null);let n=Yl(e);t.add(n),s.current=n;let r=Xl(e);t.add(r),c.current=r;let i=n.material;i instanceof va&&(i.uniforms.uPixelRatio.value=Math.min(window.devicePixelRatio||1,2))},[e]),(0,l.useEffect)(()=>{let e=o.current;if(!e)return;u.current&&=(e.remove(u.current),u.current.traverse(nu),null);let n=Ql(p?t:t.filter(e=>e.kind!==`star`));e.add(n),u.current=n},[t,p]),(0,X.jsx)(`div`,{className:`sky-dome`,ref:n,"aria-hidden":`true`})}var iu=28,au=32,ou=4.4,su=4.8;function cu(e){return 10**(-.4*e)}function lu(e,t){return e.magnitude-t.magnitude}function uu(e){let t=e.filter(e=>e.label&&e.magnitude<=ou).sort(lu).slice(0,iu).map(e=>({id:`star-${e.id}`,text:e.label,altitude:e.altitude+1.8,azimuth:e.azimuth,kind:`star`})),n=new Map;for(let t of e){if(!t.constellation||!t.constellationName||t.magnitude>su)continue;let e=n.get(t.constellation)??[];e.push(t),n.set(t.constellation,e)}return[...[...n.values()].filter(e=>e.length>=2).map(e=>{let t=[...e].sort(lu)[0],n=0,r=0,i=0,a=0;for(let t of e){let e=cu(t.magnitude),o=Lt.degToRad(t.altitude),s=Lt.degToRad(t.azimuth),c=new U(Math.cos(o)*Math.sin(s),Math.sin(o),-Math.cos(o)*Math.cos(s));n+=c.x*e,r+=c.y*e,i+=c.z*e,a+=e}if(a===0)return null;let o=new U(n/a,r/a,i/a),s=Math.hypot(o.x,o.z),c=Lt.radToDeg(Math.atan2(o.y,s)),l=(Lt.radToDeg(Math.atan2(o.x,-o.z))+360)%360;return c<=1.5?null:{id:`constellation-${t.constellation}`,text:t.constellationName??t.constellation??`Constellation`,altitude:c+4,azimuth:l,kind:`constellation`}}).filter(e=>e!==null).sort((e,t)=>t.altitude-e.altitude).slice(0,au),...t]}var du={enableHighAccuracy:!0,maximumAge:0,timeout:15e3};function fu(e){return{latitude:e.latitude,longitude:e.longitude,altitudeMeters:e.altitude??0}}function pu(e){switch(e.code){case e.PERMISSION_DENIED:return`Location permission was denied. Starry Night needs your exact device location to map the sky above you.`;case e.POSITION_UNAVAILABLE:return`Your device could not determine a precise location. Try moving to a spot with a clearer signal and retry.`;case e.TIMEOUT:return`Location took too long to resolve. Retry when your device has a stronger GPS or network signal.`;default:return`Location could not be resolved right now. Please try again in a moment.`}}function mu(){return new Promise((e,t)=>{if(!navigator.geolocation){t(Error(`Geolocation is not supported in this browser.`));return}navigator.geolocation.getCurrentPosition(t=>e(fu(t.coords)),t,du)})}function hu(e,t){if(!navigator.geolocation)return()=>{};let n=navigator.geolocation.watchPosition(t=>e(fu(t.coords)),e=>t?.(e),du);return()=>navigator.geolocation.clearWatch(n)}var gu=`https://brettonw.github.io/YaleBrightStarCatalog/bsc5-short.json`,_u=`starrynight.online-star-catalog.v1`,vu=1440*60*1e3,yu=6.5,bu={And:`Andromeda`,Ant:`Antlia`,Aps:`Apus`,Aqr:`Aquarius`,Aql:`Aquila`,Ara:`Ara`,Ari:`Aries`,Aur:`Auriga`,Boo:`Bootes`,Cae:`Caelum`,Cam:`Camelopardus`,Cap:`Capricornus`,Car:`Carina`,Cas:`Cassiopeia`,Cen:`Centaurus`,Cep:`Cepheus`,Cet:`Cetus`,Cha:`Chamaeleon`,Cir:`Circinus`,CMa:`Canis Major`,CMi:`Canis Minor`,Cnc:`Cancer`,Col:`Columba`,Com:`Coma Berenices`,CrA:`Corona Australis`,CrB:`Corona Borealis`,Crt:`Crater`,Cru:`Crux`,Crv:`Corvus`,CVn:`Canes Venatici`,Cyg:`Cygnus`,Del:`Delphinus`,Dor:`Dorado`,Dra:`Draco`,Equ:`Equuleus`,Eri:`Eridanus`,For:`Fornax`,Gem:`Gemini`,Gru:`Grus`,Her:`Hercules`,Hor:`Horologium`,Hya:`Hydra`,Hyi:`Hydrus`,Ind:`Indus`,Lac:`Lacerta`,Leo:`Leo`,Lep:`Lepus`,Lib:`Libra`,LMi:`Leo Minor`,Lup:`Lupus`,Lyn:`Lynx`,Lyr:`Lyra`,Men:`Mensa`,Mic:`Microscopium`,Mon:`Monoceros`,Mus:`Musca`,Nor:`Norma`,Oct:`Octans`,Oph:`Ophiuchus`,Ori:`Orion`,Pav:`Pavo`,Peg:`Pegasus`,Per:`Perseus`,Phe:`Phoenix`,Pic:`Pictor`,PsA:`Piscis Austrinus`,Psc:`Pisces`,Pup:`Puppis`,Pyx:`Pyxis`,Ret:`Reticulum`,Sco:`Scorpius`,Scl:`Sculptor`,Sct:`Scutum`,Ser:`Serpens`,Sex:`Sextans`,Sge:`Sagitta`,Sgr:`Sagittarius`,Tau:`Taurus`,Tel:`Telescopium`,TrA:`Triangulum Australe`,Tri:`Triangulum`,Tuc:`Tucana`,UMa:`Ursa Major`,UMi:`Ursa Minor`,Vel:`Vela`,Vir:`Virgo`,Vol:`Volans`,Vul:`Vulpecula`};function xu(e){let t=/^\s*(\d{1,2})h\s+(\d{1,2})m\s+(\d{1,2}(?:\.\d+)?)s\s*$/u.exec(e);if(!t)throw Error(`Unable to parse right ascension: ${e}`);let[,n,r,i]=t;return Number(n)+Number(r)/60+Number(i)/3600}function Su(e){let t=/^\s*([+-])(\d{1,2})°\s+(\d{1,2})′\s+(\d{1,2}(?:\.\d+)?)″\s*$/u.exec(e);if(!t)throw Error(`Unable to parse declination: ${e}`);let[,n,r,i,a]=t,o=Number(r)+Number(i)/60+Number(a)/3600;return n===`-`?-o:o}function Cu(e){if(!e)return;let t=Number(e);return Number.isFinite(t)?t:void 0}function wu(e){if(e.N)return e.N;if(e.B&&e.C)return`${e.B} ${e.C}`;if(e.F&&e.C)return`${e.F} ${e.C}`}function Tu(e){if(!e.HR||!e.RA||!e.Dec)return null;let t=Cu(e.V);if(t===void 0||t>yu)return null;let n={id:`hr-${e.HR}`,raHours:xu(e.RA),decDegrees:Su(e.Dec),magnitude:t},r=wu(e);r&&(n.label=r),e.C&&(n.constellation=e.C,n.constellationName=bu[e.C]??e.C);let i=Cu(e.K);return i!==void 0&&(n.temperatureKelvin=i),n}function Eu(){if(typeof window>`u`)return null;try{let e=window.localStorage.getItem(_u);if(!e)return null;let t=JSON.parse(e),n=Date.now()-t.cachedAt;return!Array.isArray(t.catalog)||n>vu?null:t.catalog}catch{return null}}function Du(e){if(!(typeof window>`u`))try{let t={cachedAt:Date.now(),catalog:e};window.localStorage.setItem(_u,JSON.stringify(t))}catch{}}async function Ou(e){try{let t=await fetch(gu,{signal:e,mode:`cors`});if(!t.ok)throw Error(`Catalog request failed with ${t.status}`);let n=(await t.json()).map(e=>Tu(e)).filter(e=>e!==null);return Du(n),n}catch(e){let t=Eu();if(t)return t;throw e}}var ku=149597870.69098932,Au=.017453292519943295,ju=.26179938779914946,Mu=57.29577951308232,Nu=3.819718634205488,Pu=365.24217,Fu=new Date(`2000-01-01T12:00:00Z`);2*Math.PI,180/Math.PI*3600;var Iu=484813681109536e-20,Lu=10800*60,Ru=2*Lu,zu=Lu/Math.PI;-.17-5*Math.log10(zu),695700/ku;var Bu=.996647180302104;Bu*Bu;var Vu=6378.1366;Vu/ku,Vu*Bu,1738.1/ku,1736/ku;function Hu(e){if(!Number.isFinite(e))throw console.trace(),`Value is not a finite number: ${e}`;return e}var $;(function(e){e.Sun=`Sun`,e.Moon=`Moon`,e.Mercury=`Mercury`,e.Venus=`Venus`,e.Earth=`Earth`,e.Mars=`Mars`,e.Jupiter=`Jupiter`,e.Saturn=`Saturn`,e.Uranus=`Uranus`,e.Neptune=`Neptune`,e.Pluto=`Pluto`,e.SSB=`SSB`,e.EMB=`EMB`,e.Star1=`Star1`,e.Star2=`Star2`,e.Star3=`Star3`,e.Star4=`Star4`,e.Star5=`Star5`,e.Star6=`Star6`,e.Star7=`Star7`,e.Star8=`Star8`})($||={}),$.Star1,$.Star2,$.Star3,$.Star4,$.Star5,$.Star6,$.Star7,$.Star8;var Uu;(function(e){e[e.From2000=0]=`From2000`,e[e.Into2000=1]=`Into2000`})(Uu||={});function Wu(e){var t,n,r,i,a,o,s;let c=2e3+(e-14)/Pu;return c<-500?(t=(c-1820)/100,-20+32*t*t):c<500?(t=c/100,n=t*t,r=t*n,i=n*n,a=n*r,o=r*r,10583.6-1014.41*t+33.78311*n-5.952053*r-.1798452*i+.022174192*a+.0090316521*o):c<1600?(t=(c-1e3)/100,n=t*t,r=t*n,i=n*n,a=n*r,o=r*r,1574.2-556.01*t+71.23472*n+.319781*r-.8503463*i-.005050998*a+.0083572073*o):c<1700?(t=c-1600,n=t*t,r=t*n,120-.9808*t-.01532*n+r/7129):c<1800?(t=c-1700,n=t*t,r=t*n,i=n*n,8.83+.1603*t-.0059285*n+13336e-8*r-i/1174e3):c<1860?(t=c-1800,n=t*t,r=t*n,i=n*n,a=n*r,o=r*r,s=r*i,13.72-.332447*t+.0068612*n+.0041116*r-37436e-8*i+121272e-10*a-1.699e-7*o+875e-12*s):c<1900?(t=c-1860,n=t*t,r=t*n,i=n*n,a=n*r,7.62+.5737*t-.251754*n+.01680668*r-.0004473624*i+a/233174):c<1920?(t=c-1900,n=t*t,r=t*n,i=n*n,-2.79+1.494119*t-.0598939*n+.0061966*r-197e-6*i):c<1941?(t=c-1920,n=t*t,r=t*n,21.2+.84493*t-.0761*n+.0020936*r):c<1961?(t=c-1950,n=t*t,r=t*n,29.07+.407*t-n/233+r/2547):c<1986?(t=c-1975,n=t*t,r=t*n,45.45+1.067*t-n/260-r/718):c<2005?(t=c-2e3,n=t*t,r=t*n,i=n*n,a=n*r,63.86+.3345*t-.060374*n+.0017275*r+651814e-9*i+2373599e-11*a):c<2050?(t=c-2e3,62.92+.32217*t+.005589*t*t):c<2150?(t=(c-1820)/100,-20+32*t*t-.5628*(2150-c)):(t=(c-1820)/100,-20+32*t*t)}var Gu=Wu;function Ku(e){return e+Gu(e)/86400}var qu=class e{constructor(t){if(t instanceof e){this.date=t.date,this.ut=t.ut,this.tt=t.tt;return}let n=1e3*3600*24;if(t instanceof Date&&Number.isFinite(t.getTime())){this.date=t,this.ut=(t.getTime()-Fu.getTime())/n,this.tt=Ku(this.ut);return}if(Number.isFinite(t)){this.date=new Date(Fu.getTime()+t*n),this.ut=t,this.tt=Ku(this.ut);return}throw`Argument must be a Date object, an AstroTime object, or a numeric UTC Julian date.`}static FromTerrestrialTime(t){let n=new e(t);for(;;){let e=t-n.tt;if(Math.abs(e)<1e-12)return n;n=n.AddDays(e)}}toString(){return this.date.toISOString()}AddDays(t){return new e(this.ut+t)}};function Ju(e){return e instanceof qu?e:new qu(e)}function Yu(e){function t(e){return e%Ru*Iu}let n=e.tt/36525,r=t(1287104.79305+n*129596581.0481),i=t(335779.526232+n*1739527262.8478),a=t(1072260.70369+n*1602961601.209),o=t(450160.398036-n*6962890.5431),s=Math.sin(o),c=Math.cos(o),l=(-172064161-174666*n)*s+33386*c,u=(92052331+9086*n)*c+15377*s,d=2*(i-a+o);return s=Math.sin(d),c=Math.cos(d),l+=(-13170906-1675*n)*s-13696*c,u+=(5730336-3015*n)*c-4587*s,d=2*(i+o),s=Math.sin(d),c=Math.cos(d),l+=(-2276413-234*n)*s+2796*c,u+=(978459-485*n)*c+1374*s,d=2*o,s=Math.sin(d),c=Math.cos(d),l+=(2074554+207*n)*s-698*c,u+=(-897492+470*n)*c-291*s,s=Math.sin(r),c=Math.cos(r),l+=(1475877-3633*n)*s+11817*c,u+=(73871-184*n)*c-1924*s,{dpsi:-135e-6+l*1e-7,deps:388e-6+u*1e-7}}function Xu(e){var t=e.tt/36525;return(((((-4.34e-8*t-576e-9)*t+.0020034)*t-1831e-7)*t-46.836769)*t+84381.406)/3600}var Zu;function Qu(e){if(!Zu||Math.abs(Zu.tt-e.tt)>1e-6){let t=Yu(e),n=Xu(e),r=n+t.deps/3600;Zu={tt:e.tt,dpsi:t.dpsi,deps:t.deps,ee:t.dpsi*Math.cos(n*Au)/15,mobl:n,tobl:r}}return Zu}function $u(e){let t=360*((.779057273264+.00273781191135448*e.ut+e.ut%1)%1);return t<0&&(t+=360),t}var ed;function td(e){if(!ed||ed.tt!==e.tt){let t=e.tt/36525,n=15*Qu(e).ee,r=$u(e),i=((n+.014506+((((-3.68e-8*t-29956e-9)*t-44e-8)*t+1.3915817)*t+4612.156534)*t)/3600+r)%360/15;i<0&&(i+=24),ed={tt:e.tt,st:i}}return ed.st}var nd=class{constructor(e){this.rot=e}},rd=class{constructor(e,t,n,r){this.azimuth=Hu(e),this.altitude=Hu(t),this.ra=Hu(n),this.dec=Hu(r)}};function id(e,t){let n=e*Au,r=Math.cos(n),i=Math.sin(n);return[r*t[0]+i*t[1],r*t[1]-i*t[0],t[2]]}function ad(e,t,n,r,i){let a=Ju(e);od(t),Hu(n),Hu(r);let o=Math.sin(t.latitude*Au),s=Math.cos(t.latitude*Au),c=Math.sin(t.longitude*Au),l=Math.cos(t.longitude*Au),u=Math.sin(r*Au),d=Math.cos(r*Au),f=Math.sin(n*ju),p=Math.cos(n*ju),m=[s*l,s*c,o],h=[-o*l,-o*c,s],g=[c,-l,0],_=-15*td(a),v=id(_,m),y=id(_,h),b=id(_,g),x=[d*p,d*f,u],S=x[0]*v[0]+x[1]*v[1]+x[2]*v[2],C=x[0]*y[0]+x[1]*y[1]+x[2]*y[2],w=x[0]*b[0]+x[1]*b[1]+x[2]*b[2],T=Math.hypot(C,w),E;T>0?(E=-Mu*Math.atan2(w,C),E<0&&(E+=360)):E=0;let D=Mu*Math.atan2(T,S),O=n,ee=r;if(i){let e=D,t=ld(i,90-D);if(D-=t,t>0&&D>3e-4){let t=Math.sin(D*Au),n=Math.cos(D*Au),r=Math.sin(e*Au),i=Math.cos(e*Au),a=[];for(let e=0;e<3;++e)a.push((x[e]-i*v[e])/r*t+v[e]*n);T=Math.hypot(a[0],a[1]),T>0?(O=Nu*Math.atan2(a[1],a[0]),O<0&&(O+=24)):O=0,ee=Mu*Math.atan2(a[2],T)}}return new rd(E,90-D,O,ee)}function od(e){if(!(e instanceof sd))throw`Not an instance of the Observer class: ${e}`;if(Hu(e.latitude),Hu(e.longitude),Hu(e.height),e.latitude<-90||e.latitude>90)throw`Latitude ${e.latitude} is out of range. Must be -90..+90.`;return e}var sd=class{constructor(e,t,n){this.latitude=e,this.longitude=t,this.height=n,od(this)}};new nd([[.999432765338654,-.0336771074697641,0],[.0303959428906285,.902057912352809,.430543388542295],[-.0144994559663353,-.430299169409101,.902569881273754]]);var cd;(function(e){e[e.Pericenter=0]=`Pericenter`,e[e.Apocenter=1]=`Apocenter`})(cd||={});function ld(e,t){let n;if(Hu(t),t<-90||t>90)return 0;if(e===`normal`||e===`jplhor`){let r=t;r<-1&&(r=-1),n=1.02/Math.tan((r+10.3/(r+5.11))*Au)/60,e===`normal`&&t<-1&&(n*=(t+90)/89)}else if(!e)n=0;else throw`Invalid refraction option: ${e}`;return n}var ud;(function(e){e.Penumbral=`penumbral`,e.Partial=`partial`,e.Annular=`annular`,e.Total=`total`})(ud||={});var dd;(function(e){e[e.Invalid=0]=`Invalid`,e[e.Ascending=1]=`Ascending`,e[e.Descending=-1]=`Descending`})(dd||={});function fd(e,t,n){return Math.min(n,Math.max(t,e))}function pd(e){let t=-1.46,n=10**(-.4*(6.5-t));return fd(((10**(-.4*(e-t))-n)/(1-n))**.38,.16,1)}function md(e,t,n){let r=new sd(e.latitude,e.longitude,e.altitudeMeters??0),i=[];for(let e of n){let n=ad(t,r,e.raHours,e.decDegrees,`normal`);if(n.altitude<=0)continue;let a=pd(e.magnitude),o=1.4+a**.9*7.4;i.push({id:e.id,label:e.label,constellation:e.constellation,constellationName:e.constellationName,altitude:n.altitude,azimuth:n.azimuth,magnitude:e.magnitude,temperatureKelvin:e.temperatureKelvin,screenBrightness:a,size:o})}return i.sort((e,t)=>e.magnitude-t.magnitude)}function hd(){let[e,t]=(0,l.useState)(`idle`),[n,r]=(0,l.useState)(`Preparing to request your exact location.`),[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)(0),[c,u]=(0,l.useState)([]),[d,f]=(0,l.useState)(`loading`),[p,m]=(0,l.useState)(()=>new Date),[h,g]=(0,l.useState)(!0),[_,v]=(0,l.useState)(0),y=h?p:new Date(p.getTime()+_*6e4),b=(0,l.useDeferredValue)(y),x=(0,l.useMemo)(()=>i&&d===`ready`?md(i,b,c):[],[c,d,i,b]),S=(0,l.useMemo)(()=>uu(x),[x]);(0,l.useEffect)(()=>{let e=new AbortController;async function t(){try{let t=await Ou(e.signal);if(e.signal.aborted)return;u(t),f(`ready`)}catch{if(e.signal.aborted)return;f(`error`)}}return t(),()=>{e.abort()}},[]),(0,l.useEffect)(()=>{let e=window.setInterval(()=>{m(new Date)},1e4);return()=>window.clearInterval(e)},[]),(0,l.useEffect)(()=>{let e=!1,n=()=>{};async function i(){t(`requesting`),r(`Requesting precise geolocation from your browser.`);try{let i=await mu();if(e)return;a(i),t(`ready`),r(`Precise location locked. Mapping your local sky now.`),n=hu(n=>{e||(0,l.startTransition)(()=>{a(n),t(`ready`),r(`Sky refreshed using your latest device position.`)})},n=>{e||(n.code===n.PERMISSION_DENIED?t(`denied`):t(`error`),r(pu(n)))})}catch(n){if(e)return;if(typeof n==`object`&&n&&`code`in n&&typeof n.code==`number`){let e=n;t(e.code===e.PERMISSION_DENIED?`denied`:`error`),r(pu(e));return}t(`error`),r(n instanceof Error?n.message:`Location could not be resolved.`)}}return i(),()=>{e=!0,n()}},[o]);let C=()=>{t(`idle`),r(`Retrying geolocation request.`),a(null),m(new Date),s(e=>e+1)},w=e=>{let t=Number(e.target.value);(0,l.startTransition)(()=>{g(!1),v(t)})},T=()=>{(0,l.startTransition)(()=>{g(!0),v(0),m(new Date)})},E=new Intl.DateTimeFormat(void 0,{dateStyle:`full`,timeStyle:`medium`}),D={idle:`Awaiting location`,requesting:`Requesting location`,ready:`Sky synchronized`,denied:`Location blocked`,error:`Location unavailable`}[e];return(0,X.jsx)(`main`,{className:`app-shell`,children:(0,X.jsxs)(`section`,{className:`sky-stage`,children:[(0,X.jsx)(ru,{stars:x,labels:S}),(0,X.jsx)(`div`,{className:`sky-glow`}),(0,X.jsxs)(`div`,{className:`overlay`,children:[(0,X.jsxs)(`header`,{className:`masthead`,children:[(0,X.jsx)(`p`,{className:`eyebrow`,children:`Precise Local Night Sky`}),(0,X.jsx)(`h1`,{children:`Look up from exactly where you are.`}),(0,X.jsx)(`p`,{className:`lede`,children:`Starry Night uses your current latitude and longitude to draw the visible star field above your head right now using the live Yale Bright Star Catalog. Coordinates stay in your browser, and the Sun is intentionally excluded.`})]}),(0,X.jsxs)(`section`,{className:`control-panel`,children:[(0,X.jsxs)(`div`,{className:`status-row`,children:[(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`p`,{className:`panel-label`,children:`Geolocation`}),(0,X.jsx)(`p`,{className:`status status-${e}`,children:D})]}),(e===`denied`||e===`error`)&&(0,X.jsx)(`button`,{className:`ghost-button`,onClick:C,children:`Retry location`})]}),(0,X.jsx)(`p`,{className:`supporting-copy`,children:n}),(0,X.jsx)(`p`,{className:`supporting-copy`,children:`Drag the sky or use the arrow keys to pan your camera from the Earth surface.`}),(0,X.jsxs)(`p`,{className:`supporting-copy`,children:[`Press `,(0,X.jsx)(`code`,{children:`+`}),` and `,(0,X.jsx)(`code`,{children:`-`}),` to zoom. Individual star names appear once you zoom in further.`]}),(0,X.jsxs)(`div`,{className:`telemetry-grid`,children:[(0,X.jsxs)(`article`,{children:[(0,X.jsx)(`p`,{className:`panel-label`,children:`Coordinates`}),(0,X.jsx)(`p`,{className:`data-point`,children:i?`${i.latitude.toFixed(5)}°, ${i.longitude.toFixed(5)}°`:`Waiting for GPS`})]}),(0,X.jsxs)(`article`,{children:[(0,X.jsx)(`p`,{className:`panel-label`,children:`Observer Time`}),(0,X.jsx)(`p`,{className:`data-point`,children:E.format(y)})]}),(0,X.jsxs)(`article`,{children:[(0,X.jsx)(`p`,{className:`panel-label`,children:`Visible Stars`}),(0,X.jsx)(`p`,{className:`data-point`,children:d===`error`?`Catalog unavailable`:i&&d===`ready`?x.length.toLocaleString():`Loading`})]})]}),d===`error`&&(0,X.jsx)(`p`,{className:`supporting-copy`,children:`The online star catalog could not be loaded, so the sky cannot be drawn yet.`}),(0,X.jsxs)(`div`,{className:`time-controls`,children:[(0,X.jsxs)(`div`,{className:`time-header`,children:[(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`p`,{className:`panel-label`,children:`Time Preview`}),(0,X.jsx)(`p`,{className:`time-description`,children:h?`Live sky. Use the slider to preview a different hour.`:`Previewing ${_>0?`+`:``}${_} minutes from now.`})]}),(0,X.jsx)(`button`,{className:`ghost-button`,onClick:T,disabled:h,children:`Reset to now`})]}),(0,X.jsx)(`input`,{"aria-label":`Preview time offset in minutes`,className:`time-slider`,type:`range`,min:-720,max:720,step:5,value:h?0:_,onChange:w}),(0,X.jsxs)(`div`,{className:`slider-scale`,children:[(0,X.jsx)(`span`,{children:`-12h`}),(0,X.jsx)(`span`,{children:`Now`}),(0,X.jsx)(`span`,{children:`+12h`})]})]})]})]})]})})}(0,c.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(hd,{}));